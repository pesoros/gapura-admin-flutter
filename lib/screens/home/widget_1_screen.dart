...
class Widget1Screen extends StatefulWidget {
  @override
  State<Widget1Screen> createState() => _StateWidget1Screen();
}

class _StateWidget1Screen extends State<Widget1Screen> {
  ...
  getData() async {
    String url = dotenv.env['BASE_URL'] + "api/v1/home/show/wdg_terbaru";
